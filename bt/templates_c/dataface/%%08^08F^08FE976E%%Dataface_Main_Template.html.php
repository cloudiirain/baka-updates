<?php /* Smarty version 2.6.18, created on 2014-01-09 23:39:13
         compiled from Dataface_Main_Template.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'define_slot', 'Dataface_Main_Template.html', 19, false),array('block', 'translate', 'Dataface_Main_Template.html', 97, false),array('modifier', 'escape', 'Dataface_Main_Template.html', 21, false),array('modifier', 'count', 'Dataface_Main_Template.html', 101, false),array('modifier', 'nl2br', 'Dataface_Main_Template.html', 229, false),array('function', 'block', 'Dataface_Main_Template.html', 37, false),array('function', 'actions', 'Dataface_Main_Template.html', 100, false),array('function', 'language_selector', 'Dataface_Main_Template.html', 145, false),array('function', 'actions_menu', 'Dataface_Main_Template.html', 168, false),array('function', 'bread_crumbs', 'Dataface_Main_Template.html', 176, false),array('function', 'load_record', 'Dataface_Main_Template.html', 191, false),)), $this); ?>
...
?>
				...
				<?php endif; ?>
				<option value="<?php echo $this->_tpl_vars['option_value']; ?>
"><?php echo $this->_tpl_vars['option_label']; ?>
</option>
			<?php endforeach; endif; unset($_from); ?>
			</select>
			<?php else: ?>
...
?>
				...
				<?php if (! $this->_tpl_vars['option_value']): ?>
					<?php $this->assign('option_value', $this->_tpl_vars['find_action']['name']); ?>
				<?php endif; ?>
				<input type="hidden" name="-action" value="<?php echo $this->_tpl_vars['option_value']; ?>
"/>
			<?php endforeach; endif; unset($_from); ?>
